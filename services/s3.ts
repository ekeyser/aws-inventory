...
export let s3_ListBuckets = (region: string, credentials: {
    accessKeyId: string,
    ...
    return new Promise(async (resolve) => {
        ...
        let getSignatureKey = (key: string, dateStamp: string, regionName: string, serviceName: string, signatureVer: string) => {
        ...
        let getS3HashedCanonicalRequest = (httpMethod: string, canonicalUri: string, signedHeaders: string[], queryString: string, canonicalHeaders: string[], hashed_payload: string) => {
